...
```
thor --workers 6 --amount 10000 --concurrent 100 wss://10.112.3.4:8080
```
...
Online               102033 milliseconds
Time taken           102037 milliseconds
Connected            10000
Disconnected         0
Failed               0
...
Handshaking          11      968        1256     278 5582
Latency              1       55           71      34 1911

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          278     786     1678    2022    2937    3745    4549    4849    5582
Latency              34      66      82      92      119     176     251     309     1911
```
