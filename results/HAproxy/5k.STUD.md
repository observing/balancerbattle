...
```
thor --workers 6 --amount 5000 --concurrent 100 wss://10.112.3.4:8443
```
...
Online               27512 milliseconds
Time taken           27516 milliseconds
Connected            5000
Disconnected         0
Failed               0
...
Handshaking          6       521         620     161 2689
Latency              1       45           44      40 632

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          161     580     826     1074    1466    1841    2213    2534    2689
Latency              40      56      63      70      87      109     162     197     632
```
