...
```
thor --workers 6 --amount 10000 --concurrent 100 ws://10.112.3.4:8080
```
...
Online               26951 milliseconds
Time taken           26974 milliseconds
Connected            10000
Disconnected         0
Failed               0
Total transferred    12.79MB
Total received       12.51MB

Durations (ms):

                     min     mean     stddev  median max
Handshaking          2       209         238     102 1125
Latency              0       18           38       4 526

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          102     230     332     387     578     719     899     965     1125
Latency              4       6       8       21      58      86      145     190     526
```
