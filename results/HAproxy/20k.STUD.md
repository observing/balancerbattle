...
```
thor --workers 6 --amount 20000 --concurrent 100 wss://10.112.3.4:8443
```
...
Online               102638 milliseconds
Time taken           102642 milliseconds
Connected            20000
Disconnected         0
Failed               0
...
Handshaking          5       491         630     140 2779
Latency              1       42           40      39 760

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          140     455     738     898     1567    1957    2282    2382    2779
Latency              39      53      61      66      79      94      140     184     760
```
