...
```
thor --workers 6 --amount 10000 --concurrent 100 wss://10.112.3.4:8443
```
...
Online               52399 milliseconds
Time taken           52403 milliseconds
Connected            10000
Disconnected         0
Failed               0
...
Handshaking          5       492         604     132 2830
Latency              1       42           40      39 907

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          132     503     836     1081    1463    1778    2047    2132    2830
Latency              39      52      60      64      78      99      131     172     907
```
