...
```
thor --workers 6 --amount 10000 --concurrent 100 ws://10.112.3.4:8082
```
...
Online               28430 milliseconds
Time taken           28433 milliseconds
Connected            10000
Disconnected         0
Failed               0
Total transferred    11.35MB
Total received       11.6MB

Durations (ms):

                     min     mean     stddev  median max
Handshaking          2       252         388      59 1757
Latency              0       16           32       4 698

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          59      109     351     511     875     1177    1458    1566    1757
Latency              4       6       8       18      51      79      114     149     698
```
