...
```
thor --workers 6 --amount 5000 --concurrent 100 ws://10.112.3.4:8081
```
...
Online               15635 milliseconds
Time taken           15640 milliseconds
Connected            5000
Disconnected         0
Failed               0
Total transferred    5.67MB
Total received       5.53MB

Durations (ms):

                     min     mean     stddev  median max
Handshaking          6       294         214     242 956
Latency              1       47           32      43 420

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          242     360     429     479     629     711     801     851     956
Latency              43      51      58      63      82      103     124     144     420
```
