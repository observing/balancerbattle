...
```
thor --workers 6 --amount 10000 --concurrent 100 wss://10.112.3.4:8081
```
...
Online               68653 milliseconds
Time taken           68670 milliseconds
Connected            10000
Disconnected         0
Failed               0
...
Handshaking          179     679         236     678 2046
Latency              10      62           20      60 314

Percentile (ms):

                      50%     66%     75%     80%     90%     95%     98%     98%    100%
Handshaking          678     772     826     868     989     1091    1196    1259    2046
Latency              60      68      73      76      85      94      106     120     314
```
